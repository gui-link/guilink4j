...
public class Style {
    ...
    public Color getBorderTopColor() {
        return GuilinkGetters.getFirstValue(borderTopColor, borderColor);
    }
    ...
    public Float getBorderTopWidth() {
        return GuilinkGetters.getFirstValue(borderTopWidth, borderWidth);
    }
    ...
    public LineStyleEnum getBorderTopStyle() {
        return GuilinkGetters.getFirstValue(borderTopStyle, borderStyle);
    }
    ...
    public Color getBorderLeftColor() {
        return GuilinkGetters.getFirstValue(borderLeftColor, borderColor);
    }
    ...
    public Float getBorderLeftWidth() {
        return GuilinkGetters.getFirstValue(borderLeftWidth, borderWidth);
    }
    ...
    public LineStyleEnum getBorderLeftStyle() {
        return GuilinkGetters.getFirstValue(borderLeftStyle, borderStyle);
    }
    ...
    public Color getBorderRightColor() {
        return GuilinkGetters.getFirstValue(borderRightColor, borderColor);
    }
    ...
    public Float getBorderRightWidth() {
        return GuilinkGetters.getFirstValue(borderRightWidth, borderWidth);
    }
    ...
    public LineStyleEnum getBorderRightStyle() {
        return GuilinkGetters.getFirstValue(borderRightStyle, borderStyle);
    }
    ...
    public Color getBorderBottomColor() {
        return GuilinkGetters.getFirstValue(borderBottomColor, borderColor);
    }
    ...
    public Float getBorderBottomWidth() {
        return GuilinkGetters.getFirstValue(borderBottomWidth, borderWidth);
    }
    ...
    public LineStyleEnum getBorderBottomStyle() {
        return GuilinkGetters.getFirstValue(borderBottomStyle, borderStyle);
    }
